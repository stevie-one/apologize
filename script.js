...
function drawText() {
  ...
  if (frameNumber < 300) {
    ...
    context.fillText(
      "I Apologize for all the times i have hurt you",
      canvas.width / 2,
      canvas.height / 2
    );
  ...
  if (frameNumber > 600 && frameNumber < 900) {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        ["I shouldnt have said all those things, valentina"],
        canvas.width / 2,
        canvas.height / 2,
        fontSize,
        lineHeight
  ...
  if (frameNumber > 1200 && frameNumber < 1500) {
    context.fillStyle = `rgba(255, 255, 255, ${opacity})`;
    context.fillText(
      "i promise you, no matter what happens val",
      canvas.width / 2,
      canvas.height / 2
    );
    opacity = opacity + 0.01;
  ...
  if (frameNumber > 2400 && frameNumber < 2700) {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        [
          "i deeply regret what i did, so please valentina",
        ],
        canvas.width / 2,
        canvas.height / 2,
        fontSize,
  ...
  if (frameNumber >= 3300 && frameNumber < 99999) {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        [
          "please forgive me, I wont repeat it again,",
        ],
        canvas.width / 2,
        canvas.height / 2 + 70,
        fontSize,
